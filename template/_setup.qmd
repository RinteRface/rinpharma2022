...
![Link to copy from GitHub](assets/images/png/init-github.png)
...
![Successful renv setup](assets/images/png/renv-init.png)
...
::: {.column width="50%"}
![Monkey testing instructions](assets/images/png/monkey-test.png)
:::
...
1. Create a new script `./app_audit.R`.
2. Write and call `run_audit(scope = "POC")`.
3. Look at the logs messages.
4. When done open `public/index.html` (external browser).
5. Explore the report. 
6. Modify app code and rerun ...